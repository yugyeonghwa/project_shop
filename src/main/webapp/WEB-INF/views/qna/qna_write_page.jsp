			...
			<form method="post" enctype="multipart/form-data" autocomplete="off">
				<table class="write_table">
					...
					<tr>
						...
						<td>
							<textarea id="post_content" name="post_content" cols="100" rows="20" required></textarea>
						</td>
					</tr>
					<tr>
				...
				<div class="write_btn">
					...
					<input type="button" value="등록" onclick="qna_write_ok(this.form)" />
