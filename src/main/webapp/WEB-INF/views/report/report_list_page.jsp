...
<html>
	...
	<body>
		...
		<section>
										...
										<tr>
											...
											<td style="text-align: left;">
												...
												<c:choose>
													...
													<c:otherwise>
														<a href="report_detail.do?report_idx=${k.report_idx}&cPage=${paging.nowPage}">${k.report_subject}</a>
													</c:otherwise>
												</c:choose>
											</td>
											<td>${k.u_idx}</td>
								...
								<td colspan="6">
									<ol class="btn_paging">
										<c:choose>
											...
											<c:otherwise>
												<li>
													<a href="report_list.do?cPage=${paging.beginBlock - paging.pagePerBlock}">&#8249;</a>
												</li>
											</c:otherwise>
										</c:choose>
										<c:forEach begin="${paging.beginBlock}" end="${paging.endBlock}" step="1" var="k">
											<c:choose>
												...
												<c:otherwise>
													<li>
														<a href="report_list.do?cPage=${k}">${k}</a>
													</li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
			...
			<input type="button" onclick="report_write_go()" value="글쓰기">
			</div>
