...
<html>
	<head>
		...
		<script type="text/javascript">
			function review_answer_ok(f) {
				f.action="review_answer_ok.do";
				f.submit();
			}
			...
			<form method="post" enctype="multipart/form-data" autocomplete="off">
				<table class="write_table">
					<tr>
						...
						<td><input type="text" name="review_subject" required/></td>
					</tr>
					<tr>
						<td class="write_table_subject">내용</td>
						<td><textarea name="review_content" cols="100" rows="20" required></textarea>
						</td>
					</tr>
					<tr>
				...
				<div class="write_btn">
					...
					<input type="button" value="등록" onclick="review_answer_ok(this.form)" />
